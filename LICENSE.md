...
This addon is licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/) (CC BY-NC-SA 4.0).
...
- **ShareAlike** — If you adapt the material, you must distribute your contributions under the same license (CC BY-NC-SA 4.0).
...
This license does not grant permission to use the trade marks or names of World of Warcraft; those remain the property of their respective owners.
