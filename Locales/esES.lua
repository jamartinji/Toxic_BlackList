...
COMANDOS DE CHAT
/blacklist o /tbl — Abre esta ventana sin argumentos.
/tbl Nombre motivo opcional — Añade por nombre.

/removeblacklist o /removebl — Quita por nombre.
Sin argumentos: quita al objetivo actual.
]]
