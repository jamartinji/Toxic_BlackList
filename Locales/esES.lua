...
L["BLACKLIST_MERGED_UPDATE"] = "Fila actualizada con reino y datos."
...
L["CONTEXT_ADD_BLACKLIST"] = "Añadir a la lista negra"
L["CONTEXT_REMOVE_BLACKLIST"] = "Quitar de la lista negra"
L["LIST_MENU_EDIT"] = "Editar entrada"
L["LIST_MENU_REMOVE"] = "Quitar de la lista"
L["LIST_MENU_TOXICITY"] = "Toxicidad"
L["SHARE_LIST_TOOLTIP"] = "Exportar o importar la lista negra para copia de seguridad o compartir con otros usuarios de Toxic BlackList."
L["EXPORT_FULL_MENU"] = "Exportar lista completa…"
L["IMPORT_LIST_MENU"] = "Importar lista…"
L["EXPORT_DIALOG_TITLE"] = "Exportar lista negra"
L["IMPORT_DIALOG_TITLE"] = "Importar lista negra"
L["IMPORT_PASTE_HINT"] = "Pega un export completo, un export de una sola entrada o una línea de datos (el mismo formato que una línea del export completo)."
L["IMPORT_MERGE"] = "Fusionar (omitir duplicados)"
L["IMPORT_REPLACE"] = "Reemplazar toda la lista"
L["IMPORT_REPLACE_WARN"] = "¿Sustituir toda tu lista negra por los datos importados? No se puede deshacer salvo que tengas un export de copia."
L["IMPORT_RESULT_FMT"] = "Importación: %d añadidos, %d omitidos o líneas no válidas."
L["IMPORT_ERROR_BAD"] = "Error al importar."
L["ADD_DIALOG_REALM_LABEL"] = "Reino (opcional)"
L["ADD_DIALOG_REALM_NOTE"] = "No se puede comprobar el reino: los addons no tienen la lista completa de reinos de Blizzard. Usa el nombre exacto (como en el chat o el grupo). Déjalo vacío para una entrada solo por nombre hasta cruzarte con el jugador en el juego."
L["ADD_DIALOG_CLASS_LABEL"] = "Clase"
L["ADD_DIALOG_CLASS_BUTTON"] = "Clase: —"
L["ADD_DIALOG_TOXICITY_LABEL"] = "Toxicidad"
L["ADD_DIALOG_TOXICITY_TOOLTIP"] = "Clic izquierdo: siguiente valor (0–10, vuelve al inicio). Clic derecho: anterior."
...
L["REMOVE_BLOCKED_ENTRY_LOCKED"] = "Esa entrada está bloqueada. Desbloquéala en la lista antes de quitar."
...
L["TOOLTIP_BL_TOXICITY_LABEL"] = "Toxicidad:"
...
L["OPT_MUTED_CHAT"] = "Mensajes permitidos"
L["OPT_MUTED_CHAT_UNMUTE"] = "Mensajes ignorados"
L["MUTED_CHECKBOX_LABEL"] = "Ignorar mensajes del chat"
L["EVALUATION_SKULLS_LABEL"] = "Toxicidad:"
L["EVALUATION_SKULLS_TOOLTIP"] = "Clic en un icono para marcar toxicidad (1–10). Clic derecho para borrar (0)."
...
L["SORT_TOXICITY"] = "Toxicidad"
L["UNDO_DELETE"] = "Deshacer"
L["UNDO_NOTHING"] = "Nada que deshacer"
...
/tbla — Abre el diálogo para añadir jugador.
...
L["BLACKLIST_POPUP_TEXT"] = "Campos: nombre (obligatorio), reino opcional, clase, toxicidad (0–10) y motivo."
