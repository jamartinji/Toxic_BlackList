...
L["LIST_MENU_EDIT"] = "Изменить запись"
L["LIST_MENU_REMOVE"] = "Удалить из списка"
L["LIST_MENU_TOXICITY"] = "Токсичность"
L["SHARE_LIST_TOOLTIP"] = "Экспорт или импорт чёрного списка (резервная копия или обмен с другими пользователями Toxic BlackList)."
L["EXPORT_FULL_MENU"] = "Экспорт всего списка…"
L["IMPORT_LIST_MENU"] = "Импорт списка…"
L["EXPORT_DIALOG_TITLE"] = "Экспорт чёрного списка"
L["IMPORT_DIALOG_TITLE"] = "Импорт чёрного списка"
L["IMPORT_PASTE_HINT"] = "Вставьте полный экспорт, экспорт одной записи или одну строку данных (как строка из полного экспорта)."
L["IMPORT_MERGE"] = "Объединить (пропуск дубликатов)"
L["IMPORT_REPLACE"] = "Заменить весь список"
L["IMPORT_REPLACE_WARN"] = "Заменить весь чёрный список импортированными данными? Без резервной копии не откатить."
L["IMPORT_RESULT_FMT"] = "Импорт: %d добавлено, %d пропущено или неверных строк."
L["IMPORT_ERROR_BAD"] = "Ошибка импорта."
L["ADD_DIALOG_REALM_LABEL"] = "Игровой мир (необязательно)"
L["ADD_DIALOG_REALM_NOTE"] = "Миры не проверяются: у аддонов нет полного списка миров Blizzard. Укажите точное имя (как в чате или группе). Пусто — запись только по имени, пока не встретите игрока."
L["ADD_DIALOG_CLASS_LABEL"] = "Класс"
L["ADD_DIALOG_CLASS_BUTTON"] = "Класс: —"
L["ADD_DIALOG_TOXICITY_LABEL"] = "Токсичность"
L["ADD_DIALOG_TOXICITY_TOOLTIP"] = "ЛКМ: следующее значение (0–10, по кругу). ПКМ: предыдущее."
L["BLACKLIST_PLAYER"] = "В черный список"
L["REMOVE_PLAYER"] = "Удалить игрока"
L["ROW_LOCK_TOOLTIP_UNLOCKED"] = "Разблокировано"
L["ROW_LOCK_TOOLTIP_LOCKED"] = "Заблокировано"
L["REMOVE_BLOCKED_ENTRY_LOCKED"] = "Запись заблокирована. Снимите блокировку в списке перед удалением."
...
L["TOOLTIP_BL_TOXICITY_LABEL"] = "Токсичность:"
...
L["OPT_MUTED_CHAT"] = "Сообщения разрешены"
L["OPT_MUTED_CHAT_UNMUTE"] = "Сообщения игнорируются"
L["MUTED_CHECKBOX_LABEL"] = "Игнорировать сообщения в чате"
L["EVALUATION_SKULLS_LABEL"] = "Токсичность:"
L["EVALUATION_SKULLS_TOOLTIP"] = "ЛКМ по значку: токсичность 1–10. ПКМ: сброс (0)."
...
L["BLACKLIST_POPUP_TEXT"] = "Поля: имя (обязательно), мир по желанию, класс, токсичность (0–10) и причина."
