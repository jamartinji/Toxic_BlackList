...
CHAT COMMANDS
/blacklist or /tbl — Opens this window with no arguments.
/tbl Name optional reason — Adds a player by name.

/removeblacklist or /removebl — Removes by name.
With no argument: removes your current target.
]]
