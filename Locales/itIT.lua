...
COMANDI CHAT
/blacklist o /tbl — Apre questa finestra senza argomenti.
/tbl Nome motivo opzionale — Aggiunge un giocatore per nome.

/removeblacklist o /removebl — Rimuove per nome. Senza argomenti: rimuove il bersaglio attuale.
]]
...
L["SETTINGS_HINT_OPTIONS_ONLY"] = "Questo pannello contiene solo le opzioni. L'elenco si apre con /blacklist, /tbl o dal menu."
